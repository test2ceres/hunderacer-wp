			...
			},
			{
            	...
            	onclick: function() {
				    var win = editor.windowManager.open( {
				        ...
				        onsubmit: function( e ) {
				            editor.insertContent( '[user-profile login_necessary="'+ e.data.login_necessary + '" search_field="'+ e.data.search_field + '" display_field="'+ e.data.display_field + '" user_profile_page="'+ e.data.user_profile_page + '"]');
				        }
				    });
				}
			},
