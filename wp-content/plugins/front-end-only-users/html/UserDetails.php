			...
			<div class='col-wrap'>
				<div class="tablenav top">
					<div class="alignleft actions">
						<p><?php _e("Recent User Activity", 'front-end-only-users'); ?>
					</div>
		...
		<div id='col-left'>
			<div class='col-wrap'>
				<div class="form-wrap UserDetail">
					<a href="admin.php?page=EWD-FEUP-options&DisplayPage=Users" class="NoUnderline">&#171; <?php _e("Back", 'front-end-only-users') ?></a>
					<h2><?php _e("Edit User", 'front-end-only-users'); ?>: <?php echo($UserAdmin->Username); ?></h2>
					<a class='delete-tag feup-confirm-one-user' href='admin.php?page=EWD-FEUP-options&Action=EWD_FEUP_DeleteUser&DisplayPage=Users&User_ID=<?php echo $UserAdmin->User_ID; ?>'><?php _e("Delete User", 'front-end-only-users') ?></a>
					...
					<form id="addtag" method="post" action="admin.php?page=EWD-FEUP-options&Action=EWD_FEUP_EditUser&DisplayPage=Users" class="validate" enctype="multipart/form-data">
						...
						<?php if ($Email_Confirmation == "Yes") { ?>
								<label for='Email Confirmation' id='ewd-feup-register-admin-approved-div' class='ewd-feup-field-label'><?php _e('Email Confirmed', 'front-end-only-users');?>: </label>
						...
						<?php if ($Payment_Frequency != "None") { ?>
								<label for='User Membership Fees Paid' id='ewd-feup-register-admin-approved-div' class='ewd-feup-field-label'><?php _e('Membership Fees Paid', 'front-end-only-users');?>: </label>
						...
						<?php if ($Payment_Frequency == "Yearly" or $Payment_Frequency == "Monthly") { ?>
								<label for='User Membership Fees Paid' id='ewd-feup-register-admin-approved-div' class='ewd-feup-field-label'><?php _e('Account Expiry Date', 'front-end-only-users');?>: </label>
					...
					<p class="submit"><input type="submit" name="submit" id="submit" class="button-primary" value="<?php _e('Edit User ', 'front-end-only-users') ?>"  /></p></form>
				</div>
			</div>			
		</div>
