...
<div class="form-field form-required">
	...
	<p><?php _e("The name of the field your users will see.", 'front-end-only-users') ?></p>
</div>
<div class="form-field form-required">
...
<div class="form-field">
	...
	<p><?php _e("The description of the field, which the user will see as the instruction for the field.", 'front-end-only-users') ?></p>
</div>
<div class="form-field">
...
<div class="form-field">
		...
		<p><?php _e("Should this field appear in the users' table in the admin area?", 'front-end-only-users') ?></p>
</div>
<div class="form-field">
		...
		<p><?php _e("Should this field appear in users' profiles in the front-end?", 'front-end-only-users') ?></p>
</div>
<div class="form-field">
		<label for="Field_Required"><?php _e("Required?", 'front-end-only-users') ?></label>
