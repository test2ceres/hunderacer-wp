...
function Confirm_Login($Username = "", $Third_Party_Login = "No") {
	...
	if ($feup_Label_Login_Failed_Confirm_Email == "") {$feup_Label_Login_Failed_Confirm_Email = __("Login failed - you need to confirm your e-mail before you can log in", 'front-end-only-users');}
...
function Get_User_Search_Results($search_logic, $display_field, $order_by, $order) {
